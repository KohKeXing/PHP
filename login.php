...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["cid"]) && isset($_POST["ps"])) {
        ...
        if (isset($_SESSION['block_time']) && time() - $_SESSION['block_time'] < $temporary_block_duration) {
            ...
            // Change $con to $conn to match the variable in help.php
...
<body>
  ...
  <form action="" method="POST">
    ...
    <input type="text" name="cid" id="cid" maxlength="20" placeholder="Enter your Customer ID" required>
